classdef ImageSimulation
    ...
    methods
        function [obj] = ImageSimulation(wfe,adc,fiberpos,dof)
            ...
            if nargin == 0
                ...
                obj.WFE = [0,0,0,5,0,0,0,0]; % Pupil Zernike amplitudes piston, xtilt, ytilt, etc...
...
%                 9.8710E-001 9.8057E-1 9.7411E-1]');
        ...
        function [obj] = PrepareFiberOffsets(obj)
            ...
            obj.BeamPos = zeros(length(obj.Wavelength),1); % lateral offset of the fiber translates to phase in pupil plane
        end
