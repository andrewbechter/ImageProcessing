...
opts.type = 'full'; % processing options (outdated)
...
% Function Call
%%------------------
fiber = Basler(filename,opts); % reads in data and populates fundamental object properties
